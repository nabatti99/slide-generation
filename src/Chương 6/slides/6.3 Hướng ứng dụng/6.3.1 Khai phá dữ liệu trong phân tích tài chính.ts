...
addSectionText(slide80Section, "title", "6.3.1. KHAI PHÁ DỮ LIỆU TRONG PHÂN TÍCH TÀI CHÍNH");
addSectionText(slide80Section, "content", "Data Mining for Financial Data Analysis — Lĩnh vực ứng dụng chuẩn mực và giàu có nhất");
addSectionText(slide80Section, "subContent", "\"Ngân hàng là 'phòng thí nghiệm' lý tưởng: dữ liệu đầy đủ, đáng tin cậy — và mỗi quyết định đều quy được ra tiền.\"\n\n" +
...
addText(
  slide83Content,
  "💡 Thực tiễn VN: CIC chấm điểm quốc gia; fintech thêm dữ liệu thay thế.",
  {
    x: cmToInch(0.8),
    y: 0, // trôi xuống dưới nội dung
    w: cmToInch(23.8),
...
addText(
  ...
  [
    ...
    { text: "Lần dòng tiền qua tài khoản trung gian — dùng lại nguyên bộ đồ thị con + phát hiện cộng đồng đã học.\n\n" },
...
addText(
  ...
  [
    ...
    { text: "CIC chấm điểm quốc gia + scorecard riêng của ngân hàng; fintech bổ sung dữ liệu viễn thông, hành vi app." }
  ],
  {
    x: cmToInch(0.8),
    y: cmToInch(2.0),
...
addText(
  ...
  [
    ...
    { text: "Chấm điểm rủi ro giao dịch theo thời gian thực: khung giờ, vị trí, thiết bị lạ." }
  ],
  {
    x: cmToInch(13.1),
    y: cmToInch(2.0),
...
addText(
  ...
  [
    ...
    { text: "Sàng lọc danh sách đen, phát hiện giao dịch xé nhỏ, báo cáo giao dịch đáng ngờ." }
  ],
  {
    x: cmToInch(0.8),
...
addText(
  ...
  [
    ...
    { text: "Chuỗi ARIMA (6.1.1) + sentiment tin tức (6.1.3) ➔ khuyến nghị đầu tư tự động." }
  ],
  {
    x: cmToInch(13.1),
    y: 0, // trôi dưới thẻ cùng cột
